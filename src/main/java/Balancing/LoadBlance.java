...
public class LoadBlance {
     ...
     * @return
     */
    private static List<String> MapCasttoList() {
    ...
    private static Map<String, Integer> getServerMap() {
     ...
     * @return
     */
    public static String RandomLoadBlance() {
        List<String> ipList = MapCasttoList();
     ...
     * @return
     */
    public static String IpHashLoadBlance() {
        List<String> ipList = MapCasttoList();
   ...
   private static  void  createVisul()
   {
       List<String> serverIpList = MapCasttoList();
       for (String ip : serverIpList) {
           for (int i = 0; i < visualNum; i++) {
     ...
     * @return
     */
    public static String consistencyHashLoadBlance(String str) {
     ...
     * @return
     */
    private static String weightRound(List<ServerNode> serverNodeList) {
     ...
     * 1: 循环list, 如果
     */
    private static String leastActiveLoadBalance(List<Ip_active_weight> invokers) {
    ...
    private static List<Ip_active_weight> buildIpActiveWeightList() {
        Map<String, Integer> serverMap = getServerMap();
     ...
     * @return
     */
    public  static String leastActiveLoadBalance()
    {
